...
angular.module('app')
  ...
  .constant('JQ_CONFIG', {
      ...
      screenfull:     [   'infovinity/libs/jquery/screenfull/dist/screenfull.min.js'],
  ...
  .constant('MODULE_CONFIG', [
      ...
      },
      {
          name: 'ui.select',
          files: [
              'infovinity/libs/angular/angular-ui-select/dist/select.min.js',
              'infovinity/libs/angular/angular-ui-select/dist/select.min.css'
          ]
      },
      {
